...
// ExcuteOrderRequest Execute order body
type ExcuteOrderRequest struct {
	RequestId         string `json:"requestId"`
	SignedTransaction string `json:"signedTransaction"`
}

// ExcuteOrderResponse defines model for ExcuteOrderResponse.
type ExcuteOrderResponse struct {
	...
	SwapEvents         *[]SwapEventsOrder `json:"swapEvents,omitempty"`
}

// FeeMint defines model for FeeMint.
type FeeMint = string
...
type HoldingsResponse struct {
	...
	Error          *string                     `json:"error,omitempty"`
	Tokens         *map[string][]HoldingsToken `json:"tokens,omitempty"`
	UiAmount       *uint64                     `json:"uiAmount,omitempty"`
	UiAmountString *string                     `json:"uiAmountString,omitempty"`
}

// HoldingsToken defines model for HoldingsToken.
type HoldingsToken struct {
	Account                  *string `json:"account,omitempty"`
	Amount                   *string `json:"amount,omitempty"`
	Decimals                 *int32  `json:"decimals,omitempty"`
	IsAssociatedTokenAccount *bool   `json:"isAssociatedTokenAccount,omitempty"`
...
// InputMint defines model for InputMint.
type InputMint = string
...
// OrderResponse Get order response
type OrderResponse struct {
	FeeBps                    *uint32          `json:"feeBps,omitempty"`
	FeeMint                   *FeeMint         `json:"feeMint,omitempty"`
	Gasless                   *bool            `json:"gasless,omitempty"`
	InAmount                  *string          `json:"inAmount,omitempty"`
	InUsdValue                *float32         `json:"inUsdValue,omitempty"`
	InputMint                 *InputMint       `json:"inputMint,omitempty"`
	Mode                      *string          `json:"mode,omitempty"`
	OtherAmountThreshold      *string          `json:"otherAmountThreshold,omitempty"`
	OutAmount                 *string          `json:"outAmount,omitempty"`
	OutUsdValue               *float32         `json:"outUsdValue,omitempty"`
	OutputMint                *OutputMint      `json:"outputMint,omitempty"`
	...
	RoutePlan                 *[]RoutePlanStep `json:"routePlan,omitempty"`
	Router                    *string          `json:"router,omitempty"`
	SlippageBps               SlippageBps      `json:"slippageBps"`
	SwapMode                  *SwapMode        `json:"swapMode,omitempty"`
	SwapType                  SwapType         `json:"swapType"`
	SwapUsdValue              *float32         `json:"swapUsdValue,omitempty"`
	Taker                     *Taker           `json:"taker,omitempty"`
	TotalTime                 *uint64          `json:"totalTime,omitempty"`
	Transaction               *string          `json:"transaction,omitempty"`
}

// OutputMint defines model for OutputMint.
type OutputMint = string
...
// PriceResponse Get price response
...
// SearchTokenResponse defines model for SearchTokenResponse.
type SearchTokenResponse = []SearchTokenResponseItem

// SearchTokenResponseItem defines model for SearchTokenResponseItem.
type SearchTokenResponseItem struct {
	Audit *struct {
		...
		TopHoldersPercentage    *float32 `json:"topHoldersPercentage,omitempty"`
	} `json:"audit,omitempty"`
	Cexes      *[]string `json:"cexes,omitempty"`
	CircSupply *float32  `json:"circSupply,omitempty"`
	Decimals   *uint32   `json:"decimals,omitempty"`
	Fdv        *float32  `json:"fdv,omitempty"`
	FirstPool  *struct {
		CreatedAt *string `json:"createdAt,omitempty"`
		Id        *string `json:"id,omitempty"`
	} `json:"firstPool,omitempty"`
	HolderCount       *uint64   `json:"holderCount,omitempty"`
	Icon              *string   `json:"icon,omitempty"`
	Id                *string   `json:"id,omitempty"`
	IsVerified        *bool     `json:"isVerified,omitempty"`
	Liquidity         *float32  `json:"liquidity,omitempty"`
	Mcap              *float32  `json:"mcap,omitempty"`
	Name              *string   `json:"name,omitempty"`
	OrganicScore      *float32  `json:"organicScore,omitempty"`
	OrganicScoreLabel *string   `json:"organicScoreLabel,omitempty"`
	PriceBlockId      *uint64   `json:"priceBlockId,omitempty"`
...
// ShieldResponse defines model for ShieldResponse.
type ShieldResponse struct {
	Warnings *ShieldWarnings `json:"warnings,omitempty"`
}

// ShieldWarning defines model for ShieldWarning.
type ShieldWarning struct {
	Message  *string `json:"message,omitempty"`
	Severity *string `json:"severity,omitempty"`
	Type     *string `json:"type,omitempty"`
}

// ShieldWarnings defines model for ShieldWarnings.
type ShieldWarnings map[string][]ShieldWarning

// SlippageBps defines model for SlippageBps.
type SlippageBps = uint64

// SwapEventsOrder defines model for SwapEventsOrder.
type SwapEventsOrder struct {
...
// SwapType defines model for SwapType.
type SwapType = string

// Taker defines model for Taker.
type Taker = string
...
// PriceMintAddresses defines model for PriceMintAddresses.
type PriceMintAddresses = []string

// ReferralAccountParameter defines model for ReferralAccountParameter.
type ReferralAccountParameter = string

// ReferralFeeParameter defines model for ReferralFeeParameter.
type ReferralFeeParameter = uint64
...
// TakerParameter defines model for TakerParameter.
type TakerParameter = string

// PriceGetParams defines parameters for PriceGet.
type PriceGetParams struct {
	// Ids - desired mint addresses
	Ids *PriceMintAddresses `form:"ids,omitempty" json:"ids,omitempty"`
}
...
// OrderGetParams defines parameters for OrderGet.
type OrderGetParams struct {
	...
	Taker *TakerParameter `form:"taker,omitempty" json:"taker,omitempty"`

	// ReferralAccount - The referral account address - refer to the Add Fees To Ultra guide for the step by step process.
	ReferralAccount *ReferralAccountParameter `form:"referralAccount,omitempty" json:"referralAccount,omitempty"`

	// ReferralFee - The referral fee in basis points (bps)
	ReferralFee *ReferralFeeParameter `form:"referralFee,omitempty" json:"referralFee,omitempty"`
}

// SearchTokenGetParams defines parameters for SearchTokenGet.
type SearchTokenGetParams struct {
	Empty []string `form:"" json:""`
}

// ShieldGetParams defines parameters for ShieldGet.
type ShieldGetParams struct {
	Empty []string `form:"" json:""`
}
...
// ExecuteOrderPostJSONRequestBody defines body for ExecuteOrderPost for application/json ContentType.
type ExecuteOrderPostJSONRequestBody = ExcuteOrderRequest
...
type ClientInterface interface {
	// PriceGet request
	PriceGet(ctx context.Context, params *PriceGetParams, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// ExecuteOrderPostWithBody request with any body
	ExecuteOrderPostWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	ExecuteOrderPost(ctx context.Context, body ExecuteOrderPostJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// HoldingsGet request
	HoldingsGet(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*http.Response, error)

	// OrderGet request
	OrderGet(ctx context.Context, params *OrderGetParams, reqEditors ...RequestEditorFn) (*http.Response, error)

	// SearchTokenGet request
	SearchTokenGet(ctx context.Context, params *SearchTokenGetParams, reqEditors ...RequestEditorFn) (*http.Response, error)

	// ShieldGet request
	ShieldGet(ctx context.Context, params *ShieldGetParams, reqEditors ...RequestEditorFn) (*http.Response, error)
}

func (c *Client) PriceGet(ctx context.Context, params *PriceGetParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPriceGetRequest(c.Server, params)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ExecuteOrderPostWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewExecuteOrderPostRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) ExecuteOrderPost(ctx context.Context, body ExecuteOrderPostJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewExecuteOrderPostRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) HoldingsGet(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewHoldingsGetRequest(c.Server, id)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) OrderGet(ctx context.Context, params *OrderGetParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewOrderGetRequest(c.Server, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) SearchTokenGet(ctx context.Context, params *SearchTokenGetParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewSearchTokenGetRequest(c.Server, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) ShieldGet(ctx context.Context, params *ShieldGetParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewShieldGetRequest(c.Server, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewPriceGetRequest generates requests for PriceGet
func NewPriceGetRequest(server string, params *PriceGetParams) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/price/v3")
	if operationPath[0] == '/' {
...
func NewSwapInstructionsPostRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/swap/v1/swapswap-instructions")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewExecuteOrderPostRequest calls the generic ExecuteOrderPost builder with application/json body
func NewExecuteOrderPostRequest(server string, body ExecuteOrderPostJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewExecuteOrderPostRequestWithBody(server, "application/json", bodyReader)
}

// NewExecuteOrderPostRequestWithBody generates requests for ExecuteOrderPost with any type of body
func NewExecuteOrderPostRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/ultra/v1/execute")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewHoldingsGetRequest generates requests for HoldingsGet
func NewHoldingsGetRequest(server string, id string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/ultra/v1/holdings/%s", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewOrderGetRequest generates requests for OrderGet
func NewOrderGetRequest(server string, params *OrderGetParams) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/ultra/v1/order")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
	...
	if params != nil {
		...
		if params.ReferralAccount != nil {

			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "referralAccount", runtime.ParamLocationQuery, *params.ReferralAccount); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
		...
		if params.ReferralFee != nil {
			...
			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "referralFee", runtime.ParamLocationQuery, *params.ReferralFee); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
...
// NewSearchTokenGetRequest generates requests for SearchTokenGet
func NewSearchTokenGetRequest(server string, params *SearchTokenGetParams) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/ultra/v1/search")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewShieldGetRequest generates requests for ShieldGet
func NewShieldGetRequest(server string, params *ShieldGetParams) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/ultra/v1/shield")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	// PriceGetWithResponse request
	PriceGetWithResponse(ctx context.Context, params *PriceGetParams, reqEditors ...RequestEditorFn) (*PriceGetResponse, error)
	...
	// ExecuteOrderPostWithBodyWithResponse request with any body
	ExecuteOrderPostWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*ExecuteOrderPostResponse, error)

	ExecuteOrderPostWithResponse(ctx context.Context, body ExecuteOrderPostJSONRequestBody, reqEditors ...RequestEditorFn) (*ExecuteOrderPostResponse, error)

	// HoldingsGetWithResponse request
	HoldingsGetWithResponse(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*HoldingsGetResponse, error)

	// OrderGetWithResponse request
	OrderGetWithResponse(ctx context.Context, params *OrderGetParams, reqEditors ...RequestEditorFn) (*OrderGetResponse, error)

	// SearchTokenGetWithResponse request
	SearchTokenGetWithResponse(ctx context.Context, params *SearchTokenGetParams, reqEditors ...RequestEditorFn) (*SearchTokenGetResponse, error)

	// ShieldGetWithResponse request
	ShieldGetWithResponse(ctx context.Context, params *ShieldGetParams, reqEditors ...RequestEditorFn) (*ShieldGetResponse, error)
}
...
func (r PriceGetResponse) Status() string {
...
func (r PriceGetResponse) StatusCode() int {
	if r.HTTPResponse != nil {
...
type ExecuteOrderPostResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *ExcuteOrderResponse
}

// Status returns HTTPResponse.Status
func (r ExecuteOrderPostResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r ExecuteOrderPostResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type HoldingsGetResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *HoldingsResponse
}

// Status returns HTTPResponse.Status
func (r HoldingsGetResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r HoldingsGetResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// Status returns HTTPResponse.Status
func (r OrderGetResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r OrderGetResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type SearchTokenGetResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *SearchTokenResponse
}

// Status returns HTTPResponse.Status
func (r SearchTokenGetResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r SearchTokenGetResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type ShieldGetResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *ShieldResponse
}

// Status returns HTTPResponse.Status
func (r ShieldGetResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r ShieldGetResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// PriceGetWithResponse request returning *PriceGetResponse
func (c *ClientWithResponses) PriceGetWithResponse(ctx context.Context, params *PriceGetParams, reqEditors ...RequestEditorFn) (*PriceGetResponse, error) {
	rsp, err := c.PriceGet(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePriceGetResponse(rsp)
}
...
// ExecuteOrderPostWithBodyWithResponse request with arbitrary body returning *ExecuteOrderPostResponse
func (c *ClientWithResponses) ExecuteOrderPostWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*ExecuteOrderPostResponse, error) {
	rsp, err := c.ExecuteOrderPostWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseExecuteOrderPostResponse(rsp)
}

func (c *ClientWithResponses) ExecuteOrderPostWithResponse(ctx context.Context, body ExecuteOrderPostJSONRequestBody, reqEditors ...RequestEditorFn) (*ExecuteOrderPostResponse, error) {
	rsp, err := c.ExecuteOrderPost(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseExecuteOrderPostResponse(rsp)
...
// HoldingsGetWithResponse request returning *HoldingsGetResponse
func (c *ClientWithResponses) HoldingsGetWithResponse(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*HoldingsGetResponse, error) {
	rsp, err := c.HoldingsGet(ctx, id, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseHoldingsGetResponse(rsp)
}

// OrderGetWithResponse request returning *OrderGetResponse
func (c *ClientWithResponses) OrderGetWithResponse(ctx context.Context, params *OrderGetParams, reqEditors ...RequestEditorFn) (*OrderGetResponse, error) {
	rsp, err := c.OrderGet(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseOrderGetResponse(rsp)
}

// SearchTokenGetWithResponse request returning *SearchTokenGetResponse
func (c *ClientWithResponses) SearchTokenGetWithResponse(ctx context.Context, params *SearchTokenGetParams, reqEditors ...RequestEditorFn) (*SearchTokenGetResponse, error) {
	rsp, err := c.SearchTokenGet(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseSearchTokenGetResponse(rsp)
}

// ShieldGetWithResponse request returning *ShieldGetResponse
func (c *ClientWithResponses) ShieldGetWithResponse(ctx context.Context, params *ShieldGetParams, reqEditors ...RequestEditorFn) (*ShieldGetResponse, error) {
	rsp, err := c.ShieldGet(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseShieldGetResponse(rsp)
}

// ParsePriceGetResponse parses an HTTP response from a PriceGetWithResponse call
func ParsePriceGetResponse(rsp *http.Response) (*PriceGetResponse, error) {
...
// ParseExecuteOrderPostResponse parses an HTTP response from a ExecuteOrderPostWithResponse call
func ParseExecuteOrderPostResponse(rsp *http.Response) (*ExecuteOrderPostResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &ExecuteOrderPostResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseHoldingsGetResponse parses an HTTP response from a HoldingsGetWithResponse call
func ParseHoldingsGetResponse(rsp *http.Response) (*HoldingsGetResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
...
// ParseOrderGetResponse parses an HTTP response from a OrderGetWithResponse call
func ParseOrderGetResponse(rsp *http.Response) (*OrderGetResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
...
// ParseSearchTokenGetResponse parses an HTTP response from a SearchTokenGetWithResponse call
func ParseSearchTokenGetResponse(rsp *http.Response) (*SearchTokenGetResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &SearchTokenGetResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseShieldGetResponse parses an HTTP response from a ShieldGetWithResponse call
func ParseShieldGetResponse(rsp *http.Response) (*ShieldGetResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
